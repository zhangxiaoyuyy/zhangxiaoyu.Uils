...
public class ArticleController {
	...
	public String selectsByAdmin(@RequestParam(defaultValue = "1")Integer page,@RequestParam(defaultValue = "3")Integer pageSize,Article article ,Model model) {
	 ...
	 */
	@GetMapping("selects")
	public String select(@RequestParam(defaultValue = "1")Integer page,@RequestParam(defaultValue = "3")Integer pageSize,Article article ,Model model) {
		PageInfo<Article> info = articleService.selects(article, page, pageSize);
