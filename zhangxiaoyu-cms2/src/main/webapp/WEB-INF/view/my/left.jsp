	...
	<div class="list-group">
		<ul class="list-group">
			<li class="list-group-item  text-center" ><a class="channel"
				href="javascript:void(0)"  data="/article/selects">我的文章
			</a></li>
			<li class="list-group-item  text-center"><a class="channel"
			...
			<li class="list-group-item  text-center"><a class="channel"
				...
				<li class="list-group-item  text-center"><a class="channel"
				href="javascript:void(0)" data="/conllection/toCollectList?uid=${general.id}" class="list-group-item">个人收藏</a></li>
			<li class="list-group-item  text-center"><a class="channel"
		...
		<li class="list-group-item  text-center"><a class="channel"
				href="javascript:void(0)" data="/article/publishVote" class="list-group-item">发布图片集</a></li>
