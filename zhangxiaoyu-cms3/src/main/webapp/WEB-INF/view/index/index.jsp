	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3">
				...
				<div class="card">
					<div class="card-header">发起投票</div>
					<div class="card-body">
						<ol>
							<c:forEach items="${vote}" var="article">
								<li class="text-truncate"><a href="/article/selectVote?id=${article.id }" target="_blank">${article.title}</a></li>
							</c:forEach>
						</ol>
					</div>
				</div>
